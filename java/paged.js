...
*/
    ...
    function eb(a) {
        const b = a[r] | 0;
        1 !== (b & 1) && (Object.isFrozen(a) && (a = cb(a)),
        u(a, b | 1))
    }
    function x(a, b, c) {
        return c ? a | b : a & ~b
    ...
    function Kb(a) {
        ...
        Ib(a) || (16 > a.length ? ab(Number(a)) : (a = BigInt(a),
        Za = Number(a & BigInt(4294967295)) >>> 0,
        $a = Number(a >> BigInt(32) & BigInt(4294967295))),
        a = bb());
        return a
    }
    function Lb(a) {
    ...
    function Ob(a, b, c, d) {
        if (null != a && "object" === typeof a && a.ma === kb)
            return a;
        if (!Array.isArray(a))
            return c ? d & 2 ? (a = b[db]) ? b = a : (a = new b,
            d = a.A,
            d[r] |= 34,
            b = b[db] = a) : b = new b : b = void 0,
            b;
        let e = c = a[r] | 0;
        0 === e && (e |= d & 32);
        e |= d & 2;
    ...
    function Sb(a) {
        ...
        case "object":
            if (a) {
                if (Array.isArray(a))
                    return pb || !qb(a, void 0, 9999) ? a : void 0;
    ...
    function Ub(a, b, c, d, e, f) {
        if (null != a) {
            if (Array.isArray(a))
                a = e && 0 == a.length && (a[r] | 0) & 1 ? void 0 : f && (a[r] | 0) & 2 ? a : Vb(a, b, c, void 0 !== d, e, f);
            else if (nb(a)) {
                const g = {};
                for (let h in a)
                    Object.prototype.hasOwnProperty.call(a, h) && (g[h] = Ub(a[h], b, c, d, e, f));
                a = g
            } else
                a = b(a, d);
            return a
    ...
    function $b(a, b, c=ib) {
        if (null != a) {
            ...
            a.ma === kb && (c = a.A,
            d = c[r],
            a = d & 2 ? a : Qb(a.constructor, ac(c, d, !0)));
            return a
        }
    }
    function ac(a, b, c) {
    ...
    function F(a, b, c) {
        ...
        lc(k) || (b = k,
        d ? k = x(k, !g.length || 16 & k && (!m || 32 & k) ? 2 : 2048, !0) : k = x(k, 32, !1),
        k !== b && u(g, k),
        d && Object.freeze(g));
        h && lc(k) && (g = cb(g),
        k = jc(k, e, !1),
    ...
    function Bc(a, b, c) {
        if (null != c) {
            ...
            if (!Bb(c))
                throw yb("int64");
            "string" === typeof c ? c = Kb(c) : d ? (c = Math.trunc(c),
    ...
    ;var N = class {
        ...
        toJSON() {
            if (ob)
                var a = Xb(this, this.A, !1);
            else
                a = Vb(this.A, Yb, void 0, void 0, !1, !1),
                a = Xb(this, a, !0);
            return a
        }
    }
    ...
    function Xb(a, b, c) {
            ...
            a: {
                ...
                for (var z in w)
                    if (Object.prototype.hasOwnProperty.call(w, z)) {
                        ...
                        if (Array.isArray(a)) {
                            h = a;
                            if (!Ya && qb(a, d, +z) || !Xa && mb(a) && 0 === a.size)
                                a = null;
                            a != h && (c = !0)
                        }
                        null != a ? f[z] = a : c = !0
        ...
        for (e = +!!(e & 512) - 1; 0 < k; k--) {
            z = k - 1;
            n = b[z];
            if (!(null == n || !Ya && qb(n, d, z - e) || !Xa && mb(n) && 0 === n.size))
                break;
            t = !0
        }
        if (!v && !t)
...
*/
    ...
    ;
    function Jd() {
        var a = P(Vc).h(Kd.g, Kd.defaultValue)
          , b = S.document;
        if (a.length && b.head)
            for (const c of a)
                c && b.head && (a = wd("META"),
    ...
    var Ld = ()=>{
      ...
      , Od = a=>{
        var b = Nd;
        "complete" === b.readyState || "interactive" === b.readyState ? (Hd.push(a),
        1 == Hd.length && (window.Promise ? Promise.resolve().then(Id) : window.setImmediate ? setImmediate(Id) : setTimeout(Id, 0))) : b.addEventListener("DOMContentLoaded", a)
    }
    ;
    ...
    function te(a) {
        a && qe && se() && (qe.clearMarks(`goog_${a.label}_${a.uniqueId}_start`),
        qe.clearMarks(`goog_${a.label}_${a.uniqueId}_end`))
    }
    function ue(a) {
        a.g = !1;
        a.h != a.i.google_js_reporting_queue && (se() && Ia(a.h, te),
        a.h.length = 0)
    }
    class ve {
        constructor(a) {
        ...
        if (a instanceof Array) {
            ...
            d < c.length) {
                ...
                for (let g = 0; g < a.length; g++)
                    f.push(ye(a[g], b, c, d + 1, e));
                return f.join(c[d])
            }
        } else if ("object" == typeof a)
            return e = e || 0,
            2 > e ? encodeURIComponent(xe(a, b, c, d, e + 1)) : "...";
    ...
    var Ee = class {
        ...
        J(a, b, c, d, e) {
            ...
            try {
                ...
                for (let ja = 0, cg = k.length - 1; ja <= cg; ++ja)
                    k[ja].depth = cg - ja;
                m = p;
    ...
    function Pf(a, ...b) {
        try {
            a.C && 65536 <= Ve(a.g.concat(b), a.i).length && Uf(a),
            a.j && !a.s && (a.s = !0,
            Vf(a.j, ()=>{
                Uf(a)
            }
    ...
    ;const ih = new fh(["google-auto-placed"],{
    ...
    ;var qh = new O(1271)
      ...
      , Eh = new O(217)
      , Fh = new Nc(1307)
      , Gh = new Mc(572636916,25)
      , Hh = new Mc(579884443)
      , Ih = new Oc(556791602,["1", "2", "4", "6"])
      , Jh = new O(579884441)
      , Kh = new Mc(572636915,150)
      , Lh = new Mc(579884442)
      , Mh = new O(561639564)
      , Nh = new O(600847635)
      , Oh = new O(600719280)
    ...
    function Xh(a, b, c) {
        ...
        ph(b) && (b.setAttribute("data-init-display", b.style.display),
    ...
    var gi = (a,b)=>!((Cd.test(b.google_ad_width) || Bd.test(a.style.width)) && (Cd.test(b.google_ad_height) || Bd.test(a.style.height)))
            ...
            if (c = "true" != e.google_full_width_responsive)
                a: {
                    ...
                    for (b = di(a); c; c = c.parentElement)
                        if ((d = xd(c, a)) && (e = R(d.width)) && !(e >= b) && "visible" != d.overflow) {
                            c = !0;
                            break a
                        }
                    c = !1
      ...
      , ki = (a,b,c,d)=>{
        ...
        !0 !== e ? a = e : "true" == d.google_full_width_responsive || ei(c, b) ? (b = di(b),
        a = b - a,
    ...
    var qi = (a,b,c,d=e=>e)=>{
      ...
      , vi = a=>b=>b.height() <= a
      , si = (a,b)=>ii(a, b) < ci(b).clientHeight - 100
      , wi = (a,b)=>{
        ...
        do
            ...
            (d = qi(b, a, "maxHeight", R)) && (c = Math.min(c, d));
    ...
    class Wi {
        ...
        J(a, b, c=.01, d, e="jserror") {
            ...
            p.error_rep_loaded || (vd(p.document, this.B),
    ...
    function aj(a) {
        ...
        if (H(a, 1) || a.getId() || 0 < hc(a, 4, Nb).length) {
            ...
            b = b ? new Vi(b,G(a, 2),G(a, 5),bj(I(a, 6))) : null;
        return b
    }
    var cj = {
        1: 1,
        ...
        b.forEach(e=>{
            if (Ac(e, Gi, 1, Ji)) {
                ...
                if (E(e, kh, 1) && E(E(e, kh, 1), U, 1) && E(e, kh, 2) && E(E(e, kh, 2), U, 1)) {
                    const g = jj(a, E(E(e, kh, 1), U, 1))
                      , h = jj(a, E(E(e, kh, 2), U, 1));
                    if (g && h)
                        for (var f of hj({
                            anchor: g,
                            position: I(E(e, kh, 1), 2)
                        }, {
                            anchor: h,
                ...
                Ac(e, Hi, 2, Ji) ? kj(a, Ac(e, Hi, 2, Ji), c) : Ac(e, Fi, 3, Ji) && lj(a, Ac(e, Fi, 3, Ji), d)
        }
        );
        return new mj(c,d)
    }
    ...
    const kj = (a,b,c)=>{
        E(b, kh, 2) ? (b = E(b, kh, 2),
        (a = jj(a, E(b, U, 1))) && c.set(ea(a), I(b, 2))) : E(b, U, 1) && (a = nj(a, E(b, U, 1))) && a.forEach(d=>{
            d = ea(d);
            c.set(d, 1);
            c.set(d, 4);
            c.set(d, 2);
    ...
    var rj = (a,b,c)=>W.ea(a, b, c)
      ...
      , uj = (a,b,c,d)=>{
        ...
        return 0 == e.indexOf("TagError") ? ((b instanceof ge ? b.error : b).pbr = !0,
        !1) : W.J(a, b, c, d)
    }
    ;
    var vj = class {
    ...
    function Ij(a, b) {
        ...
        b: {
            ...
            f = [];
            for (const [K,ua] of [[h.lc, k], [h.ub, n], [h.oc, v], [h.mc, m], [h.qc, t], [h.kc, w], [h.nc, z], [h.vb, A]])
                !1 === K ? f = f.concat(ua) : B = B.concat(ua);
            h = Hj(B);
            f = Hj(f);
            h = h.slice(0);
            for (l of f)
        ...
        for (g = 0; g < c.length; g++) {
            ...
            if (E(h, dh, 4) && e.contains(I(E(h, dh, 4), 1)) && 1 === I(h, 8) && Kj(h, d)) {
                ...
                if (m = Lj(l, h, m, d))
                    ...
                    E(h, U, 1) && null != G(E(h, U, 1), 5) && (k.numPostPlacementsPlaced ? k.numPostPlacementsPlaced++ : k.numPostPlacementsPlaced = 1),
    ...
    function Lj(a, b, c, d) {
        ...
        a: {
            try {
                ...
                (t = c.ya) && t.parentNode && (w = t.parentNode,
                w.removeChild(t),
                ph(w) && (w.style.display = w.getAttribute("data-init-display") || "none"));
                t = !1;
                break a
            }
            t = !0
    ...
    function mk(a) {
        ...
        if (ek(a))
            if (!1 === a.gdprApplies)
                a = !0;
            else if ("tcunavailable" === a.tcString || void 0 === a.gdprApplies && !b.ic || "string" !== typeof a.tcString || !a.tcString.length)
                a = !b.jc;
            else {
                b: {
    ...
    function pl(a, b) {
        if (!b?.g() || 0 === L(b, 1).length || 0 == F(b, el, 2).length)
            return null;
        const c = L(b, 1);
        let d;
        try {
    ...
    class kl {
        constructor(a, b) {
            ...
            d = pl(this, a.Ya);
            a = a.Va;
            a?.g() && 0 !== L(a, 2).length ? (b = ec(a, Jk, 1) ? E(a, Jk, 1) : Ik(),
            a = {
                uspString: L(a, 2),
                xa: Kk(b)
            }) : a = null;
    ...
    function dm(a) {
        sj("atf_ad_settings_from_ppabg", {
            p_s: a
        }, .01)
    }
    const em = a=>{
        sj("overlay_settings_from_ppabg", {
            p_s: a
        }, .01)
    }
      , fm = (a,b)=>{
    ...
    function om(a) {
        if (Sl(a.l) && !J(a.g, 22))
            return Tg(Error("invtag"));
        a: {
            var b = a.l;
            var c = a.i;
            a = a.g;
            if (a?.j())
                (b = a?.h()?.g()?.g()) && (0 < F(b, mh, 1).length || Q(yh) && 0 < F(b, nh, 3).length) ? dm(!1) : b = null;
            else {
                if (a?.i()) {
                    const d = a?.g()?.g()
                      , e = a?.g()?.h()?.g()?.g();
        ...
        a = F(b, Ki, 2),
        c = vc(c, 7, a),
        Q(yh) && 0 < F(b, nh, 3).length && (a = new oh,
        b = F(b, nh, 3),
        b = vc(a, 1, b),
        tc(c, 6, b)),
        b = Rg(c)) : b = Tg(Error("invtag"));
        return b
    }
    function pm(a) {
        ok({
    ...
    ;function Em(a) {
        ...
        null == a.google_reactive_ads_global_state.sideRailPlasParam && (a.google_reactive_ads_global_state.sideRailPlasParam = new Map)) : a.google_reactive_ads_global_state = new Fm;
    ...
    function Lm(a, b, c, d) {
        ...
        ec(c, Oi, 24) && (d = fj(a),
        d.availableAbg = !0,
        d.ablationFromStorage = !!E(c, Oi, 24)?.g()?.g());
        ...
        var e = E(c, Bi, 13);
        e && 1 === I(e, 1) ? (d = 0,
        (e = E(e, Ai, 6)) && G(e, 3) && (d = G(e, 3) || 0),
        Pl(a, d)) : E(c, Oi, 24)?.g()?.g() && (fj(a).ablatingThisPageview = !0,
        Pl(a, 1));
        $d(3, [c.toJSON()]);
    ...
    function En(a, b) {
        ...
        if ("pedestal" === b.google_content_recommendation_ui_type)
            return new Bn(9,new Dn(a,Math.floor(a * b.google_phwr)));
        var c = md();
        468 > a ? c ? (c = a - 8 - 8,
        c = Math.floor(c / 1.91 + 70) + Math.floor(11 * (c * vn.mobile_banner_image_sidebyside + wn.mobile_banner_image_sidebyside) + 96),
        a = {
            aa: a,
            Z: c,
            K: 1,
    ...
    var Qn = (a,b,c,d,e)=>{
        "false" == e.google_full_width_responsive ? c = {
            F: a,
            G: 1
        } : "autorelaxed" === b && e.google_full_width_responsive || Pn(b) || e.google_ad_resize ? (b = ki(a, c, d, e),
        c = !0 !== b ? {
            F: a,
            G: b
        } : {
      ...
      , Tn = (a,b,c,d,e)=>{
        ...
        const k = R(d.style.width)
          , m = R(d.style.height)
          , {W: l, T: n, pa: v, ab: t} = Rn(f, b, c, d, e, h);
        h = Sn(b, v);
        var w;
        const z = (w = qi(d, c, "marginLeft", R)) ? w + "px" : ""
          , A = (w = qi(d, c, "marginRight", R)) ? w + "px" : "";
        w = qi(d, c, "zIndex") || "";
        return new Bn(h,l,v,null,t,g,n,z,A,m,k,w)
    }
      , Pn = a=>"auto" == a || /^((^|,) *(horizontal|vertical|rectangle) *)+$/.test(a)
      , Rn = (a,b,c,d,e,f)=>{
        b = Un(c, a, b);
        let g;
        var h = !1;
    ...
    var Wn = (a,b,c,d,e)=>{
        ...
        const {F: g, G: h} = f;
        if (!0 !== h || a == g)
            return new Bn(12,new pi(a,d),null,null,!0,h,100);
    ...
    var Yn = (a,b)=>{
        ...
        if ("link" === c)
            return 4;
        if ("fluid" == c)
            return "in-article" !== b.google_ad_layout || !a.location || "#hffwroe2etop" != a.location.hash && "#hffwroe2etoq" != a.location.hash ? 8 : (Xn(b),
            1);
    ...
    function eo(a, b) {
        ...
        for (d = 0; d < c; d++) {
            ...
            if (/data-/.test(e.name)) {
                ...
                b.hasOwnProperty(f) || (e = co(f, e.value),
                null !== e && (b[f] = e))
            }
        }
    }
    ...
    function go(a, b, c, d) {
        ...
        if (488 > di(c)) {
            ...
            if (d = vm(f.location, "google_responsive_slot_preview") || Q(Eh) || Xl(f, 1, e, d))
                b: if (b.google_reactive_ad_format || b.google_ad_resize || Yn(c, b) || gi(a, b))
                    d = !1;
                else {
        ...
        if (g = Yn(c, b))
            ...
            c.location && "#gfwmrp" == c.location.hash || 12 == b.google_responsive_auto_format && "true" == b.google_full_width_responsive ? $n(10, a, b, c, !1) : .01 > Math.random() && 12 === b.google_responsive_auto_format && (a = ki(a.offsetWidth || parseInt(a.style.width, 10) || b.google_ad_width, c, a, b),
            !0 !== a ? (b.efwr = !1,
    ...
    async function uo(a) {
        ...
        if (b.j && !b.g.le.includes(1)) {
            ...
            var d = new kf;
            Q(vh) ? (Ec(a, 4, b.i),
            Ec(d, 1, b.i)) : (Ec(a, 4, b.l?.document?.URL),
            Ec(d, 1, b.l?.document?.URL));
            var e = ho(b.l);
            0 !== e && ff(a, Ze(e));
            Rf(b.h, nf(qo(b, c), a));
            Vf(b.s, ()=>{
    ...
    var Fo = {
        [3]: {
            ...
            ,
            [69]: a=>Co(a, p.document),
            [70]: a=>Do(a, p.document)
        },
        [4]: {
            [3]: ()=>Fd(),
            [6]: a=>{
    ...
    function Go(a, b) {
        ...
        for (const f of b)
            for (const g of F(f, Gl, 2))
                if (0 !== F(g, Fl, 2).length) {
                    b = xc(Hb(cc(g, 8)));
                    M(g, 4) && !M(g, 13) && (b = c.get(M(g, 4)) ?? 0,
                    d = xc(Hb(cc(g, 1))) * F(g, Fl, 2).length,
                    c.set(M(g, 4), b + d));
                    d = [];
    ...
    function Lo(a, b, c, d) {
        ...
        for (const v of [0, 1, 2])
            for (const [t,w] of a.ka[v].entries()) {
                var m = t
                  , l = w;
                const z = new uf;
                ...
                if (n.length)
                    for (const A of n)
                        k.push(A.O);
                else if (!a.za && (2 === v ? (n = d[1],
                nc(z, 2, vf, Cb(m))) : n = d[0],
                m = n?.(String(m)) ?? (2 === v && 1 === M(l[0].qa, 11) ? void 0 : d[0](String(m))),
                void 0 !== m)) {
                    for (const A of l)
                        if (A.Xa === b) {
                            l = m - A.ib;
                            ...
                            const B = A.fb
                              , K = A.Bb;
                            0 <= l && l < n * B && l % B === K && Oe(E(A.qa, He, 3), h) && Oe(E(A.O, He, 3), h) && (l = M(A.qa, 13),
                            0 !== l && void 0 !== l && (n = a.i[String(l)],
                            void 0 !== n && n !== A.O.getId() ? ag(a.M, a.i[String(l)], A.O.getId(), l) : a.i[String(l)] = A.O.getId()),
                            k.push(A.O))
                        }
                    0 !== qc(z, vf) && (D(z, 3, Fb(m), 0),
                    g.push(z))
                }
            }
        for (const v of k)
    ...
    ;function So({sb: a, I: b, config: c, nb: d=Bo(), ob: e=0, M: f=new bg(E(a, Il, 5)?.g() ?? 0,E(a, Il, 5)?.h() ?? 0,E(a, Il, 5)?.i() ?? !1), ka: g=Go({
        [0]: new Map,
        [1]: new Map,
        [2]: new Map
    }, F(a, Hl, 2))}) {
        d.hasOwnProperty("init-done") ? (wg(12, d, ()=>{}
        )(F(a, Hl, 2).map(h=>h.toJSON())),
        wg(13, d, ()=>{}
        )(F(a, Re, 1).map(h=>h.toJSON()), e),
        b && wg(14, d, ()=>{}
        )(b),
        To(e, d)) : (No(new Oo(g,e,f,c), d),
        xg(d),
        yg(d),
        zg(d),
        To(e, d),
        sg(F(a, Re, 1), [e], f, void 0, !0),
        fg = fg || !(!c || !c.wb),
        Ro(Fo),
        b && Ro(b))
    }
    ...
    function mp(a, b, c) {
        ...
        case 2:
            const d = op(a);
            if (d)
                return c.some(f=>pp(d, f));
            break;
        case 1:
            const e = qp(a);
            if (e)
                return b.some(f=>pp(e, f))
        }
        return !1
    }
    function np(a) {
    ...
    function Ap(a, b) {
        const c = tp !== window.scrollX || up !== window.scrollY ? [] : vp
          , d = sp();
    ...
    function Dp(a) {
        if (!a.Na) {
            ...
            window.LayoutShift && (b += jp("cls", a.C),
            b += jp("mls", a.X),
            b += ip("nls", a.ra),
            window.LayoutShiftAttribution && (b += jp("cas", a.s),
            b += ip("nas", a.Ma),
            b += jp("was", a.Ra)),
            b += jp("wls", a.ta),
            b += jp("tls", a.Qa));
            window.LargestContentfulPaint && (b += ip("lcp", a.Ka),
            b += ip("lcps", a.Ja));
            window.PerformanceEventTiming && a.Ha && (b += ip("fid", a.Ga));
            window.PerformanceLongTaskTiming && (b += ip("cbt", a.B),
            b += ip("mbt", a.H),
            b += ip("nlt", a.sa));
            let d = 0;
    ...
    function Mp(a, b, c) {
        ...
        if (f && f.Sa && "on" !== b.google_adtest && !e) {
            ...
            if (!f.ua || f.ua && (e || 0) >= f.ua)
                ...
                "slot" === f.Jb && (null !== Dd(a.getAttribute("width")) && a.setAttribute("width", "0"),
                null !== Dd(a.getAttribute("height")) && a.setAttribute("height", "0"),
                a.style.width = "0px",
                a.style.height = "0px"),
                !0
        }
        if ((f = xd(a, c)) && "none" === f.display && !("on" === b.google_adtest || 0 < b.google_reactive_ad_format || d))
    ...
    function Np(a) {
        ...
        for (let d = 0, e = b[d]; d < b.length; e = b[++d]) {
            var c = e;
            if (Jp(c) && "reserved" !== c.dataset.adsbygoogleStatus && (!a || e.id === a))
                return e
        }
        return null
    }
    ...
    function Wp(a) {
        ...
        if ((a = qd(c, "client") || a.getAttribute("data-ad-client") || "") && a !== b.google_ad_client)
    ...
    function Tp(a, b, c, d) {
        ...
        if (0 !== e)
            ...
            "js" === b.google_ad_output)
                ...
                if (c = 0 === (X(S).first_tag_on_page || 0) && Hm(b))
                    so(f=>{
                        zc(rc(f), 5) || (f = rc(f),
                        Dc(f, 5))
                    }
    ...
    function lq() {
        var a = S.document
          , b = Yd`https://googleads.g.doubleclick.net`;
        const c = a.createElement("LINK");
        c.crossOrigin = "";
        a: {
            if (b instanceof bd)
                c.href = ed(b).toString();
            else {
                if (-1 === sd.indexOf("preconnect"))
                    throw Error('TrustedResourceUrl href attribute required with rel="preconnect"');
                if (b instanceof id)
                    b = b instanceof id && b.constructor === id ? b.g : "type_error:SafeUrl";
                else {
                    c: {
                        try {
                            var d = new URL(b)
    ...
    ;(function(a, b, c, d=()=>{}
        ...
        const c = 2012 < xc(G(b, 1)) ? `_fy${xc(G(b, 1))}` : ""
          , d = L(b, 3);
        b = L(b, 2);
